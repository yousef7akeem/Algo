...
<body>
    <div class="container">
        ...
        <div id="adminSection" class="hidden">
            <div class="card animate__animated animate__slideIn">
                <div class="header">
    ...
    <script>
        ...
        function showToast(title, message, type = 'success') {
            ...
            successToast.classList.add('animate__animated', 'animate__fadeInRight');
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    successToast.classList.remove('animate__fadeInRight', 'animate__fadeOutRight');
                }, 500);
            }, 3000);
        }
